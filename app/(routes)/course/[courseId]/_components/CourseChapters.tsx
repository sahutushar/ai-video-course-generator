...
function CourseChapters({ course }: Props) {
  return (
    <div className="w-full px-6 mb-20 relative">
      ...
      {/* Preview Container */}
      <div className="max-w-6xl mx-auto -mt-24 bg-white/90 backdrop-blur-lg border rounded-xl shadow-lg relative z-10" style={{padding: '40px'}}>
            ...
            <Card key={index} className="rounded-xl shadow-sm border bg-white">
              ...
              <CardHeader>
                <div className="flex gap-4 items-center">
                  ...
                  {/* Number Circle */}
                  <div className="flex items-center justify-center font-bold flex-shrink-0" style={{width: '44px', height: '44px', borderRadius: '50%', backgroundColor: '#3b82f6', color: 'white', fontSize: '20px'}}>
                    {index + 1}
                  </div>
              ...
              <CardContent>
                <div className="flex items-start justify-between gap-10">
                  ...
                  {/* Video Player */}
                  <div className='border-2 border-gray-300 rounded-xl overflow-hidden bg-gray-100 shadow-md flex-shrink-0' style={{width: '300px', aspectRatio: '16/9'}}>
                    <Player
